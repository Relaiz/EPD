...
namespace TeacherScheduleApp.ViewModels
{
    public class DayViewModel : ViewModelBase
    {
        ...
        public void LoadEvents()
        {
            ...
            .Select(e => new
            {
                S = e.AllDay ? e.ArrivalTime : e.StartTime,
                E = e.AllDay ? e.DepartureTime : e.EndTime
            })
            .ToList();
            ...
            foreach (var e in events)
            {
                ...
                var s = e.AllDay ? e.ArrivalTime : e.StartTime;
                var ee = e.AllDay ? e.DepartureTime : e.EndTime;

                e.IsInactive = specialIntervals.Any(sp => s < sp.E && sp.S < ee);
            }
        ...
        private async void OnEventClicked(Event existing)
        {
            ...
            else if (ev.Id != 0)
            {
                ...
                {
                    _eventService.DeleteEvent(existing.Id);
