...
namespace TeacherScheduleApp.Services
{
    ...
    public class AutomaticEventsGeneratorService
    {
        ...
        public async Task RegenerateDailyEventsAsync(DateTime date)
        {
            ...
            if (lunchEnd > lunchStart) busyCandidates.Add((lunchStart, lunchEnd));
            ...
            foreach (var (s, e) in gaps)
            {
                ...
                newEvents.Add(new Event
                {
                    Title = (s >= lunchEnd) ? global.AutoEventNamePostLunch : global.AutoEventNamePreLunch,
                    StartTime = s,
                    EndTime = e,
            ...
            foreach (var ev in newEvents.Where(e => e.EventType == EventType.Work))
                ev.Title = (ev.StartTime >= lunchEnd) ? global.AutoEventNamePostLunch : global.AutoEventNamePreLunch;
